...
PointToPointNetDevice::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PointToPointNetDevice")
    ...
    .AddTraceSource ("MacTxDetail", 
                     "Trace source indicating a packet has arrived "
                     "for transmission by this device",
                     MakeTraceSourceAccessor (&PointToPointNetDevice::m_macTxTraceDetail),
                     "ns3::Packet::TracedCallback")  
    .AddTraceSource ("MacTxDrop", 
                     ...
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("MacTxDropDetail", 
                     "Trace source indicating a packet has been dropped "
                     "by the device before transmission",
                     MakeTraceSourceAccessor (&PointToPointNetDevice::m_macTxDropTraceDetail),
                     "ns3::Packet::TracedCallback")                 
    ...
    .AddTraceSource ("PhyTxBegin", 
                     ...
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyTxBeginDetail", 
                     "Trace source indicating a packet has begun "
                     "transmitting over the channel",
                     MakeTraceSourceAccessor (&PointToPointNetDevice::m_phyTxBeginTraceDetail),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyTxEnd", 
                     ...
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyTxEndDetail", 
                     "Trace source indicating a packet has been "
                     "completely transmitted over the channel",
                     MakeTraceSourceAccessor (&PointToPointNetDevice::m_phyTxEndTraceDetail),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyTxDrop", 
                     ...
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyTxDropDetail", 
                     "Trace source indicating a packet has been "
                     "dropped by the device during transmission",
                     MakeTraceSourceAccessor (&PointToPointNetDevice::m_phyTxDropTraceDetail),
                     "ns3::Packet::TracedCallback")
#if 0
    // Not currently implemented for this device
    ...
    .AddTraceSource ("PhyRxEnd", 
                     ...
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyRxEndDetail", 
                     "Trace source indicating a packet has been "
                     "completely received by the device",
                     MakeTraceSourceAccessor (&PointToPointNetDevice::m_phyRxEndTraceDetail),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyRxDrop", 
                     ...
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyRxDropDetail", 
                     "Trace source indicating a packet has been "
                     "dropped by the device during reception",
                     MakeTraceSourceAccessor (&PointToPointNetDevice::m_phyRxDropTraceDetail),
                     "ns3::Packet::TracedCallback")
...
PointToPointNetDevice::TransmitStart (Ptr<Packet> p)
{
  ...
  if (result == false)
    {
      m_phyTxDropTrace (p);
      m_phyTxDropTraceDetail(p,this->m_ifIndex,this->GetNode()->GetId());
    }
  return result;
}
...
PointToPointNetDevice::TransmitComplete (void)
{
  ...
  m_phyTxEndTraceDetail(m_currentPkt, this->m_ifIndex, this->GetNode()->GetId());
  m_currentPkt = 0;
  ...
  if (m_receiveErrorModel && m_receiveErrorModel->IsCorrupt (packet) ) 
    {
      ...
      m_phyRxDropTraceDetail(packet,this->m_ifIndex,this->GetNode()->GetId());
    }
  else 
    {
      // 
      ...
      m_phyRxEndTraceDetail(packet,this->m_ifIndex, this->GetNode()->GetId());
  ...
  uint16_t protocolNumber)
{
  ...
  if (IsLinkUp () == false)
    {
      ...
      m_macTxDropTraceDetail (packet, this->m_ifIndex, this->GetNode()->GetId());
      return false;
    }
  ...
  m_macTxTrace (packet);
  m_macTxTraceDetail(packet, this->m_ifIndex, this->GetNode()->GetId());
